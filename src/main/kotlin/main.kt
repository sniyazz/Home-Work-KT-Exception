...
fun main() {
    val postOne = Post(
        1, 165002, 165003, 777, 1650508085, "One", 77, 88, true,
    ...
    val postTwo = Post(
        2, 165002, 165003, 777, 1650508085, "two", 77, 88, true,
        Comments(12, true, true, true, true), copyright(12, "", "New name", "type"),
        likes(100, true, true, true), repost(15, true), views(200), "post",
        geo("Cont", "55.55 49.49"), 101, true, false, false, true, true,
        true, donut(false, 1662000, "No dount", true, "All"),
...
object WallService {
    ...
    fun createComment(postId: Int, comment: Comments): Comments {
        for (post in posts) {
            ...
            } //else throw PostNotFoundException("Post id $postId not found")
        }
        return throw PostNotFoundException("Post id $postId not found")
    }
}
